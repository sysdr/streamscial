...
export class MetricsServer {
  ...
  private updateStats(): void {
    ...
    this.metrics.stats.eventsPerSecond = Math.floor(Math.random() * 3) + 1; // Very slow updates
    this.metrics.stats.latencyP99 = Math.floor(Math.random() * 5) + 50;
    this.metrics.stats.activeWindows = Math.floor(Math.random() * 2) + 1;
  }
